...
char check_function(const char *func_to_run, const char *data, int expected)
{
...
char *test_failures()
{
	mu_assert(check_function("fail_on_purpose", "Hello", 1), "failed_on_purpose should failed.");
